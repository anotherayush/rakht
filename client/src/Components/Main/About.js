...
const About = () => {
  return (
    <div className='px-44'>
      ...
      <p className='text-right text-5xl text-sm'>
        <br />
        An effort by byte brigade 
      </p>
    </div>
  )
}
